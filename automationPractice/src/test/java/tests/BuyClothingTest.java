...
public class BuyClothingTest {
    ...
    public void TestBuyClothing() throws Exception {
        ...
        try {
            ...
            String screenshotArquivo = "D:\\Downloads\\Automation\\test_reports\\AutomationPage" + Generators.dateTimeToFile() + test.getMethodName() + ".png";
            ...
            screenshotArquivo = "D:\\Downloads\\Automation\\test_reports\\AutomationPage" + Generators.dateTimeToFile() + test.getMethodName() + ".png";
            Screenshot.takeScreenshot(webDriver, screenshotArquivo);
